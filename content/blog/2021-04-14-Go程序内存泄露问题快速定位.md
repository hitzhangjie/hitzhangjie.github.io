...
这也算是一种比较通用的排查方式，所以这里也简单提下，在排查内存泄露问题时，根据情况（比如环境问题无法安装go，bcc之类分析工具等等）甚至可以考虑先通过这种方式来分析一下。总之，灵活选择合适的方式吧。

#### 内存及pmap基础

进程中的内存区域大致可以划分如下，如果对这个划分不熟悉，建议参考内存相关知识，see:
...
借助pmap查看进程内存空间分布情况，是比较常见的一种方式，如：
...
上述命令只是输出的信息的详细程度不同，可以通过命令的帮助信息来详细了解。在我们理解了进程的内存类型、pmap的使用之后，就可以对发生内存泄露的程序进行一定的分析。
...
conf.LoadConfig循环体每次迭代间隔1s，task.NewTask循环体每次间隔2s。
...
比如，你发现有段anon内存区域，它的内存数量再增加，或者且这样的区段数量再增加（可以通过前后对比pmap输出来发现）:
...
我们注意到地址`000000c000000000`以及`00007f26010ad000`开始的区间RSS内存数量涨了，这说明这里物理内存占用增加了，再明确程序存在内存泄露的前提下，这样的内存区域可以作为可疑内存区去分析一下。

或者，是有连续的大内存区块，也是待分析的可疑对象，或者这样的内存区块比较多，也应该作为可疑的分析对象。

找到可疑内存区域之后，就尝试将其内存区域内存导出，导出后再借助strings、hexdump等工具进行分析，通常会打印出一些字符串相关的信息，一般这些信息会被帮助我们联想起，这些数据大约对应着程序中的哪些数据接口、代码逻辑。
...
SXPFD
EXPF
...CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC...TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT....CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC...TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC...TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC...TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
...
```
...
*
01100000  43 43 43 43 43 43 43 43  43 43 43 43 43 43 43 43  |CCCCCCCCCCCCCCCC|
*
01300000  54 54 54 54 54 54 54 54  54 54 54 54 54 54 54 54  |TTTTTTTTTTTTTTTT|
```
...
使用 gcore转储整个进程，原理上有些类似，gcore会在转储完后立即detach进程，比手动dump速度快，对traced进程的影响时间短，但是转储文件一般比较大（记得ulimit -c设置下），coredump文件使用hexdump分析的时候也可以选择性跳过一些字节，以分析感兴趣的可疑内存区。
